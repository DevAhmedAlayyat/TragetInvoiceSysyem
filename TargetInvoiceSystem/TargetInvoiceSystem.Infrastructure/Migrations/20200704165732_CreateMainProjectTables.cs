...
{
    public partial class CreateMainProjectTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    MainUnitId = table.Column<Guid>(nullable: false),
                    SubUnitId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    MainUnitId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    SubUnitId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    ProductUnitId = table.Column<Guid>(nullable: false),
                    InvoiceId = table.Column<Guid>(nullable: false),
                    Qty = table.Column<int>(nullable: false),
                    TotalPrice = table.Column<double>(nullable: false),
                    Discount = table.Column<double>(nullable: false),
                    NetPrice = table.Column<double>(nullable: false),
                    IsSellInvoice = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceProducts_ProductUnits_ProductUnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceProducts_ProductUnitId",
                table: "InvoiceProducts",
